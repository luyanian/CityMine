...
import cn.soft_x.citymine.activity.InvitationActivity;
import cn.soft_x.citymine.activity.MainActivity;
import cn.soft_x.citymine.activity.NearCompanyActivity;
import cn.soft_x.citymine.activity.WebViewActivity;
import cn.soft_x.citymine.activity.WoActivity;
import cn.soft_x.citymine.http.HttpUrl;
import cn.soft_x.citymine.http.MyXUtilsCallBack;
import cn.soft_x.citymine.model.ADInfo;
import cn.soft_x.citymine.model.HomeModel;
import cn.soft_x.citymine.utils.Constant;
import cn.soft_x.citymine.view.CycleViewPager;
import cn.soft_x.citymine.view.ViewFactory;
...
//            mContext.getRlTitleRoot().setVisibility(View.VISIBLE);
    ...
    @OnClick({R.id.fragment_iv_search, R.id.fragment_iv_person, R.id.fragment_rl_huoche, R.id.news_tv_more, R.id.news_item_1, R.id.news_item_2,
            R.id.ll_yaoqinghan, R.id.ll_xiaoxi, R.id.fragment_ll_fujin})
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.fragment_rl_huoche:
                // 只是这个按钮id懒得改了，就没改名字，现在的功能是叫做采购
                MainActivity activity = (MainActivity) getActivity();
                activity.mainBottomBar.selectTab(2);
//                activity.onTabSelected(2);
                break;
