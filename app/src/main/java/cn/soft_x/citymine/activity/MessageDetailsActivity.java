...
import cn.soft_x.citymine.adapter.MessageDetailsAdapter;
import cn.soft_x.citymine.db.MyDBControl;
import cn.soft_x.citymine.http.HttpUrl;
import cn.soft_x.citymine.model.MessageDetailModel;
            ...
            case 1:
                switch (mData.get(position).getXXLX()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        intent.putExtra(Constant.WEB_URL,HttpUrl.API_HOST+"/s/page/caigou-dhsecbjxq.html");
                        break;
                    case 3:
                        intent.putExtra(Constant.WEB_URL,HttpUrl.API_HOST+"/s/page/caigou-dhsecbjxq.html");
                        break;
                    case 4:
                        intent.putExtra(Constant.WEB_URL,HttpUrl.API_HOST+"/s/page/fabu-xq.html");
                        break;
                }
                break;
            case 2:
