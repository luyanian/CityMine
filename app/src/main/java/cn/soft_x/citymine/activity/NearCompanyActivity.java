...
import cn.soft_x.citymine.adapter.NearCompanyAdapter;
            ...
            public void success(String result) {
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        String org_pic = "";
                        if (object1.has("org_pic")) {
                            JSONObject org_picObj = object1.getJSONObject("org_pic");
                            org_pic = org_picObj.getString("big");
                        }
