...
import cn.soft_x.citymine.model.LoginModel;
...
public class WelcomeActivity extends Activity {
    ...
    private int msg = -1;//消息标记

    private void init() {
        msg = getIntent().getIntExtra("msg", -1);
        ...
        x.http().post(params, new MyXUtilsCallBack() {
            ...
            public void finished() {
                if (isSuccess()) {
                    ...
                    JPushInterface.setAlias(CityMineApplication.getAppContext(), model.getYHID(), new TagAliasCallback() {
                        @Override
