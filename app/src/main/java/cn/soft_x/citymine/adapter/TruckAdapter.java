...
public class TruckAdapter extends BaseAdapter implements TruckItemAdapter.CheckedForAllListener {
    ...
    public TruckAdapter(List<TruckModel.DataBean> dataBeen) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            convertView = LayoutInflater.from(CityMineApplication.getAppContext()).inflate(R.layout.item_truck, parent, false);
        ...
        TruckItemAdapter adapter = new TruckItemAdapter(item.getList(), position, this);
    ...
    public void OnCheckedForALLListener(int position) {
        ...
        Logger.e("OnCheckedForALLListener");
        this.notifyDataSetChanged();
    }
    ...
    class OnTruckOnClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            notAll = false;
            Logger.e("itemTruckCheck is click" + dataBeen.get(pos).isChecked());
